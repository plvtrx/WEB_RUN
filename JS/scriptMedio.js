...
function street() {
    ...
    carropX+= (velocidadeCarro) * Math.min(Math.random()*11, 5);
    ...
    carrop2X-= (velocidadeCarro) * Math.min(Math.random()*11, 5);
    ...
    carrop3X+=(velocidadeCarro) * Math.min(Math.random()*11, 5);
    ...
    carrop4X-= (velocidadeCarro) * Math.min(Math.random()*11, 5);
    ...
    carrop5X+= (velocidadeCarro) * Math.min(Math.random()*11, 5);
