...
function street() {
    ...
    carropX+= (velocidadeCarro) * Math.min(Math.random()*6, 4,5);
    ...
    carrop2X-= (velocidadeCarro) * Math.min(Math.random()*8, 4,5);
    ...
    carrop3X+=(velocidadeCarro) * Math.min(Math.random()*7, 4,5);
    ...
    carrop4X-= (velocidadeCarro) * Math.min(Math.random()*8, 4,5);
    ...
    carrop5X+= (velocidadeCarro) * Math.min(Math.random()*7, 4,5);
